...
- **[OWASP/agent-memory-guard](https://github.com/OWASP/www-project-agent-memory-guard)** - Runtime defense against memory poisoning attacks (OWASP ASI06) in AI agent memory stores — detects prompt injection persistence, instruction hijacking, and cross-agent contamination in Mem0, Zep, and ChromaDB
