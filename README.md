...
- **[Web3ok/deploy-verify-skill](https://github.com/Web3ok/deploy-verify-skill)** - 7-step production deployment closed-loop: SHA-256 file verification, .env protection, cross-OS permission fix, database migration coordination, rollback with security review, log monitoring with secret redaction. Born from 5 real production incidents.
