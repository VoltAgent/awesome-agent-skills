...
- **[matdev83/hermes-cursor-dispatcher](https://github.com/matdev83/hermes-cursor-dispatcher/tree/main/skills/cursor-delegate)** - Hermes Agent skill for safely delegating repository work to Cursor CLI, with support for Grok-4.5-xhigh and isolated Git worktrees
