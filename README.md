...
- **[corrideluca/uivoid](https://github.com/corrideluca/uivoid-cli/tree/main/skill/uivoid)** - Provision authenticated MCP subdomains for existing, optionally self-hosted APIs
