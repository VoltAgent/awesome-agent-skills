...
- **[imran-siddique/agent-os](https://github.com/imran-siddique/agent-os)** - Kernel-level governance for AI agents — deterministic policy enforcement (not prompt-based) with tool filtering, budget caps, and audit logging. Merged into [microsoft/agent-lightning](https://github.com/microsoft/agent-lightning/pull/478) (14k★). Install: `pip install agent-os-kernel`
