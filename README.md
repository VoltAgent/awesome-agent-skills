...
- **[bdnhost/claude-skills](https://github.com/bdnhost/claude-skills)** - Investigative journalism + Israeli press-law: `lahav433` (FBI-grade OSINT, Intelligence Cycle, forensic accounting with Benford's Law and procurement compliance, pre-publication legal review with triple-source verification) and `journalism-legal-il` (defamation, privacy, FOIA, source protection — produces safe-to-publish edits with change explanations). Hebrew + English. Companion auto-discovered registry at [claude-skills.bdnhost.net](https://claude-skills.bdnhost.net/) cataloging 250+ skills across the ecosystem.
