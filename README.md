...
- **[Piccolo123/url-manager](https://github.com/Piccolo123/url-manager)** - Agent-first cross-platform URL collection & knowledge management. AI agents auto-register, collect, categorize, tag, search, and share web links with collaborative shared categories, full-text search, and magic-link delivery to users.
