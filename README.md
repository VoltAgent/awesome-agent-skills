...
- **[forcewake/remarkable-send](https://github.com/forcewake/remarkable-send) - Send articles and documents to the reMarkable e-ink tablet as perfectly typeset PDFs: pages sized 1:1 to the panel, measured clickable TOC, Floyd-Steinberg halftone images, mermaid diagrams rendered to grayscale. Extracts docx/epub/pdf/html, review-first upload flow; Hermes-native, works in any SKILL.md agent
