...
<details>
<summary><h3 style="display:inline">Product Management Skills by Product on Purpose</h3></summary>

68 product management skills by [Product on Purpose](https://github.com/product-on-purpose), organized around a six-phase Triple Diamond lifecycle. Covers discovery through iteration, plus foundation capabilities, workshop facilitation tools for Foundation Sprint and Design Sprint, and library utilities. Apache-2.0, conformant with the [agentskills.io specification](https://agentskills.io/specification), and every skill ships a published worked-output sample. Also available as a Claude Code plugin.

**Discover**

- **[product-on-purpose/discover-competitive-analysis](https://github.com/product-on-purpose/pm-skills/tree/main/skills/discover-competitive-analysis)** - Creates a structured competitive analysis comparing features, pricing, and positioning across 3-5 dire...
- **[product-on-purpose/discover-interview-synthesis](https://github.com/product-on-purpose/pm-skills/tree/main/skills/discover-interview-synthesis)** - Synthesizes user research interviews into actionable insights, patterns, and recommendations
- **[product-on-purpose/discover-journey-map](https://github.com/product-on-purpose/pm-skills/tree/main/skills/discover-journey-map)** - Maps a customer journey across stages, touchpoints, emotional curve, pain points, and moments of truth...
- **[product-on-purpose/discover-market-sizing](https://github.com/product-on-purpose/pm-skills/tree/main/skills/discover-market-sizing)** - Estimate market opportunity (TAM, SAM, SOM) using multiple sizing frameworks (top-down, bottom-up, com...
- **[product-on-purpose/discover-stakeholder-summary](https://github.com/product-on-purpose/pm-skills/tree/main/skills/discover-stakeholder-summary)** - Maps the people and groups with a stake in a project, documenting their needs, concerns, influence, an...

**Define**

- **[product-on-purpose/define-hypothesis](https://github.com/product-on-purpose/pm-skills/tree/main/skills/define-hypothesis)** - Defines a testable hypothesis with clear success metrics and a validation approach
- **[product-on-purpose/define-jtbd-canvas](https://github.com/product-on-purpose/pm-skills/tree/main/skills/define-jtbd-canvas)** - Creates a Jobs to be Done canvas capturing the functional, emotional, and social dimensions of a custo...
- **[product-on-purpose/define-opportunity-tree](https://github.com/product-on-purpose/pm-skills/tree/main/skills/define-opportunity-tree)** - Creates an opportunity solution tree connecting a desired outcome to customer opportunities and candid...
- **[product-on-purpose/define-prioritization-framework](https://github.com/product-on-purpose/pm-skills/tree/main/skills/define-prioritization-framework)** - Run applicable prioritization frameworks (RICE, ICE, MoSCoW, Weighted Scoring, Kano) against a list of...
- **[product-on-purpose/define-problem-statement](https://github.com/product-on-purpose/pm-skills/tree/main/skills/define-problem-statement)** - Creates a clear problem framing document with user impact, business context, and success criteria

**Develop**

- **[product-on-purpose/develop-adr](https://github.com/product-on-purpose/pm-skills/tree/main/skills/develop-adr)** - Creates an Architecture Decision Record following the Nygard format to document significant technical...
- **[product-on-purpose/develop-design-rationale](https://github.com/product-on-purpose/pm-skills/tree/main/skills/develop-design-rationale)** - Documents the reasoning behind design decisions including alternatives considered, trade-offs evaluate...
- **[product-on-purpose/develop-solution-brief](https://github.com/product-on-purpose/pm-skills/tree/main/skills/develop-solution-brief)** - Creates a concise one-page solution overview that communicates the proposed approach, key decisions, a...
- **[product-on-purpose/develop-spike-summary](https://github.com/product-on-purpose/pm-skills/tree/main/skills/develop-spike-summary)** - Documents the results of a completed technical or design spike, capturing the original question, appro...

**Deliver**

- **[product-on-purpose/deliver-acceptance-criteria](https://github.com/product-on-purpose/pm-skills/tree/main/skills/deliver-acceptance-criteria)** - Generates structured Given/When/Then acceptance criteria for a user story or feature slice, covering t...
- **[product-on-purpose/deliver-edge-cases](https://github.com/product-on-purpose/pm-skills/tree/main/skills/deliver-edge-cases)** - Documents edge cases, error states, boundary conditions, race conditions, and recovery paths for a fea...
- **[product-on-purpose/deliver-launch-checklist](https://github.com/product-on-purpose/pm-skills/tree/main/skills/deliver-launch-checklist)** - Creates a cross-functional pre-launch checklist covering engineering, design, marketing, support, lega...
- **[product-on-purpose/deliver-prd](https://github.com/product-on-purpose/pm-skills/tree/main/skills/deliver-prd)** - Creates a comprehensive Product Requirements Document that aligns stakeholders on what to build, why...
- **[product-on-purpose/deliver-release-notes](https://github.com/product-on-purpose/pm-skills/tree/main/skills/deliver-release-notes)** - Creates user-facing release notes that communicate new features, improvements, and fixes in clear, ben...
- **[product-on-purpose/deliver-user-stories](https://github.com/product-on-purpose/pm-skills/tree/main/skills/deliver-user-stories)** - Generates user stories in the standard persona, action, benefit story format from product requirements...

**Measure**

- **[product-on-purpose/measure-dashboard-requirements](https://github.com/product-on-purpose/pm-skills/tree/main/skills/measure-dashboard-requirements)** - Specifies what questions a dashboard must answer and the metrics, visualizations, filters, and data so...
- **[product-on-purpose/measure-experiment-design](https://github.com/product-on-purpose/pm-skills/tree/main/skills/measure-experiment-design)** - Designs an A/B test or experiment with variants, success metrics, sample size, and duration for an exi...
- **[product-on-purpose/measure-experiment-results](https://github.com/product-on-purpose/pm-skills/tree/main/skills/measure-experiment-results)** - Documents the results of a completed experiment or A/B test with statistical analysis, learnings, and...
- **[product-on-purpose/measure-instrumentation-spec](https://github.com/product-on-purpose/pm-skills/tree/main/skills/measure-instrumentation-spec)** - Specifies what analytics events to track, when they fire, and what properties to include, as a contrac...
- **[product-on-purpose/measure-okr-grader](https://github.com/product-on-purpose/pm-skills/tree/main/skills/measure-okr-grader)** - Scores completed OKR sets at cycle close with KR-level scoring per the canonical OKR type enum (commit...
- **[product-on-purpose/measure-survey-analysis](https://github.com/product-on-purpose/pm-skills/tree/main/skills/measure-survey-analysis)** - Analyze survey results into actionable PM insights

**Iterate**

- **[product-on-purpose/iterate-lessons-log](https://github.com/product-on-purpose/pm-skills/tree/main/skills/iterate-lessons-log)** - Creates a structured lessons learned entry for organizational memory
- **[product-on-purpose/iterate-pivot-decision](https://github.com/product-on-purpose/pm-skills/tree/main/skills/iterate-pivot-decision)** - Documents a strategic pivot or persevere decision with the evidence, analysis, and rationale
- **[product-on-purpose/iterate-refinement-notes](https://github.com/product-on-purpose/pm-skills/tree/main/skills/iterate-refinement-notes)** - Documents backlog refinement session outcomes including stories refined, estimates, questions raised...
- **[product-on-purpose/iterate-retrospective](https://github.com/product-on-purpose/pm-skills/tree/main/skills/iterate-retrospective)** - Facilitates and documents a team retrospective capturing what went well, what to improve, and action i...

**Foundation**

- **[product-on-purpose/foundation-build-risk-review](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-build-risk-review)** - Runs a fast pre-build risk review on a product idea, feature request, or scope change, naming the sing...
- **[product-on-purpose/foundation-lean-canvas](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-lean-canvas)** - Produces a one-page lean canvas across nine interlocking blocks (problem, customer, UVP, solution, cha...
- **[product-on-purpose/foundation-meeting-agenda](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-meeting-agenda)** - Produces an attendee-facing agenda that sets what will be discussed, who owns each topic, and how time...
- **[product-on-purpose/foundation-meeting-brief](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-meeting-brief)** - Produces a private strategic preparation document for the user before a meeting that matters
- **[product-on-purpose/foundation-meeting-recap](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-meeting-recap)** - Produces a topic-segmented post-meeting summary for attendees with decisions highlighted and actions c...
- **[product-on-purpose/foundation-meeting-synthesize](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-meeting-synthesize)** - Cross-meeting archaeology skill
- **[product-on-purpose/foundation-okr-writer](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-okr-writer)** - Drafts, reviews, rewrites, and coaches outcome-based OKR sets across team, department, product, or com...
- **[product-on-purpose/foundation-persona](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-persona)** - Generates an evidence-calibrated product or marketing persona using the canonical v2.5 output contract
- **[product-on-purpose/foundation-prioritized-action-plan](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-prioritized-action-plan)** - Produce a comprehensive, evidence-grounded prioritized action plan from any PM input (notes, transcrip...
- **[product-on-purpose/foundation-stakeholder-briefings](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-stakeholder-briefings)** - Turns any source artifact (spec, discovery, research, GTM plan, experiment results, retro, or raw note...
- **[product-on-purpose/foundation-stakeholder-update](https://github.com/product-on-purpose/pm-skills/tree/main/skills/foundation-stakeholder-update)** - Produces async communication to stakeholders, primarily non-attendees and secondarily some attendees w...

**Workshop Tools (Foundation Sprint, Design Sprint)**

- **[product-on-purpose/tool-design-sprint-brief](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-design-sprint-brief)** - Pre-sprint brief that locks challenge, sprint questions, team and role assignments, customer recruitin...
- **[product-on-purpose/tool-design-sprint-decide-and-storyboard](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-design-sprint-decide-and-storyboard)** - Day 3 (Wednesday) move of a Design Sprint that runs the art museum layout, heat map, speed critique, s...
- **[product-on-purpose/tool-design-sprint-map-and-target](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-design-sprint-map-and-target)** - Day 1 (Monday) move of a Design Sprint that produces the bundled Monday artifact containing long-term...
- **[product-on-purpose/tool-design-sprint-prototype-plan](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-design-sprint-prototype-plan)** - Day 4 (Thursday) move of a Design Sprint that produces the planning artifact for the day
- **[product-on-purpose/tool-design-sprint-readiness](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-design-sprint-readiness)** - Pre-sprint diagnostic that determines whether a team should run a Design Sprint now, postpone it, or d...
- **[product-on-purpose/tool-design-sprint-sketch](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-design-sprint-sketch)** - Day 2 (Tuesday) move of a Design Sprint that structures lightning demos and the four-step independent...
- **[product-on-purpose/tool-design-sprint-test-and-score](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-design-sprint-test-and-score)** - Day 5 (Friday) sprint-closing move of a Design Sprint that produces the bundled Friday artifact coveri...
- **[product-on-purpose/tool-foundation-sprint-approach-options](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-foundation-sprint-approach-options)** - Day 2 morning move of a Foundation Sprint
- **[product-on-purpose/tool-foundation-sprint-basics](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-foundation-sprint-basics)** - Day 1 morning move of a Foundation Sprint
- **[product-on-purpose/tool-foundation-sprint-brief](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-foundation-sprint-brief)** - Pre-sprint brief that locks scope, the decision the sprint must unlock, team and role assignments, log...
- **[product-on-purpose/tool-foundation-sprint-differentiation](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-foundation-sprint-differentiation)** - Day 1 afternoon move of a Foundation Sprint
- **[product-on-purpose/tool-foundation-sprint-founding-hypothesis](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-foundation-sprint-founding-hypothesis)** - Day 2 end capstone move of a Foundation Sprint
- **[product-on-purpose/tool-foundation-sprint-magic-lenses](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-foundation-sprint-magic-lenses)** - Day 2 afternoon move of a Foundation Sprint
- **[product-on-purpose/tool-foundation-sprint-readiness](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-foundation-sprint-readiness)** - Pre-sprint diagnostic that determines whether a team should run a Foundation Sprint now, postpone it...
- **[product-on-purpose/tool-note-and-vote](https://github.com/product-on-purpose/pm-skills/tree/main/skills/tool-note-and-vote)** - Structured group-decision mechanic that captures silent ideation, voting summaries, and Decider sign-o...

**Library Utilities**

- **[product-on-purpose/utility-mermaid-diagrams](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-mermaid-diagrams)** - Teaches PMs to create syntactically valid mermaid diagrams by selecting the right diagram type for the...
- **[product-on-purpose/utility-pm-changelog-curator](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-changelog-curator)** - Draft CHANGELOG entries from git log via the pm-changelog-curator sub-agent, applying the repo hygiene...
- **[product-on-purpose/utility-pm-critic](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-critic)** - Run adversarial review on a PM artifact via the pm-critic sub-agent
- **[product-on-purpose/utility-pm-release-conductor](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-release-conductor)** - Walk the guided 6-gate release runbook (G0 readiness, G1 adversarial review, G2 version bump and CHANG...
- **[product-on-purpose/utility-pm-skill-auditor](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-skill-auditor)** - Run a repo-wide cross-cutting governance audit via the pm-skill-auditor sub-agent
- **[product-on-purpose/utility-pm-skill-builder](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-skill-builder)** - Guides contributors from a PM skill idea to a complete Skill Implementation Packet aligned with pm-ski...
- **[product-on-purpose/utility-pm-skill-iterate](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-skill-iterate)** - Applies targeted improvements to an existing pm-skills skill based on feedback, validation reports, or...
- **[product-on-purpose/utility-pm-skill-validate](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-skill-validate)** - Audits an existing pm-skills skill against structural conventions and quality criteria
- **[product-on-purpose/utility-pm-workflow-builder](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-workflow-builder)** - Guides a contributor from a workflow idea to a complete Workflow Implementation Packet (draft workflow...
- **[product-on-purpose/utility-pm-workflow-orchestrator](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-pm-workflow-orchestrator)** - Run an ordered sequence of pm-skills against one input, pausing for go/no-go and stopping on a failed...
- **[product-on-purpose/utility-slideshow-creator](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-slideshow-creator)** - Generates professional presentations from a JSON deck specification using 18 slide types with dark/lig...
- **[product-on-purpose/utility-update-pm-skills](https://github.com/product-on-purpose/pm-skills/tree/main/skills/utility-update-pm-skills)** - Checks for newer pm-skills releases, compares local vs
