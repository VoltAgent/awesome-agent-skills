...
- **[shepsci/kaggle-skill](https://github.com/shepsci/kaggle-skill)** - Complete Kaggle integration — account setup, competition reports, dataset/model downloads, notebook execution, submissions, and badge collection
