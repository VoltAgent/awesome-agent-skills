...
- **[openhumancy/openhumancy-skill](https://github.com/openhumancy/openhumancy-skill)** — Delegate real-world tasks to human workers via OpenHumancy API (TON payments)
- 
</details>
