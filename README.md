...
- **[captkernel/Skills_Curator](https://github.com/captkernel/Skills_Curator)** - Proactive skill curator with judgment that activates without being asked. Fingerprints your project, surfaces matching skills on drift, listens for symptoms ("slow tests", "ugly UI") and maps them to skills. Pre-install security scan (14 patterns), persistent pros/cons/conflicts decisions, PR-ready markdown export, cross-agent migration to 9 agents. Two flavors: full Python or no-Python markdown-only
