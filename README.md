...
- **[twzrd-sol/wzrd-velocity](https://github.com/twzrd-sol/wzrd-final/tree/main/.claude/skills/wzrd-velocity)** - Real-time AI model velocity signals from Switchboard oracle on Solana
