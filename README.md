...
- **[thryxagi/obsd-launchpad](https://github.com/lordbasilaiassistant-sudo/thryxagi/tree/main/skills/obsd-launchpad)** - Deploy tokens for free on Base, earn OBSD on every swap
